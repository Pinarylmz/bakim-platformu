...
document.addEventListener('DOMContentLoaded', () => {
    try {
        ...
        if (!kbModal || !openKbSidebarBtn) return;
...
# Replace the broken KB Logic block entirely
import re
content = re.sub(r'// Global Knowledge Base Logic.*', kb_js_logic, content, flags=re.DOTALL)

with open(filepath, 'w', encoding='utf-8') as f:
    f.write(content)

print("Fixed auth.js KB syntax and encoding.")
